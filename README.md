...
● [DEBUG] This call to "require" will not be bundled because the argument is not a string literal [unsupported-require-call]
  ...
  server.mjs                 1.1mb ⚠️
  chunk-YDDSDMQW.mjs       499.6kb
  chunk-LHT367ZI.mjs        19.7kb
...
styles.css          | styles        |   0 bytes |                 0 bytes
                    ...
                    | Initial Total | 236.67 kB |                67.08 kB

Application bundle generation complete. [9.215 seconds]
Done in 9.92s.
```
Sat Nov 25 10:14:20 AM EST 2023
