...
● [DEBUG] This call to "require" will not be bundled because the argument is not a string literal [unsupported-require-call]
  ...
  server.mjs                 1.1mb ⚠️
  chunk-YGUSPAT3.mjs       499.3kb
  chunk-FB5MW4DU.mjs        19.7kb
...
main.js             | main          | 203.73 kB |                56.47 kB
polyfills.js        | polyfills     |  32.69 kB |                10.59 kB
styles.css          | styles        |   0 bytes |                 0 bytes

                    | Initial Total | 236.42 kB |                67.07 kB

Application bundle generation complete. [7.124 seconds]
Done in 7.94s.
```
Sun Nov 12 09:43:44 AM EST 2023
