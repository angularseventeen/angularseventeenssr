...
● [DEBUG] This call to "require" will not be bundled because the argument is not a string literal [unsupported-require-call]
  ...
  server.mjs                 1.1mb ⚠️
  chunk-PIV52UII.mjs       499.8kb
  chunk-I6FNUO6X.mjs        19.7kb
...
main.js             | main          | 204.08 kB |                56.57 kB
polyfills.js        | polyfills     |  32.69 kB |                10.59 kB
styles.css          | styles        |   0 bytes |                 0 bytes

                    | Initial Total | 236.77 kB |                67.17 kB

Application bundle generation complete. [7.662 seconds]
Done in 8.36s.
```
Sun Dec 10 12:13:40 PM EST 2023
