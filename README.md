...
● [DEBUG] Lookbehind assertions in regular expressions are not available in the configured target environment ("chrome120.0", "edge119.0", "firefox115.0", "ios16.0", "node20.9.0", "safari16.0" + 5 overrides) [unsupported-regexp]
...
Application bundle generation complete. [10.708 seconds]
Done in 11.44s.
```
Sat Jan 27 12:29:35 PM EST 2024
