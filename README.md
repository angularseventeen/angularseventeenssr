...
● [DEBUG] This call to "require" will not be bundled because the argument is not a string literal [unsupported-require-call]
  ...
  server.mjs                 1.1mb ⚠️
  chunk-5UCBGXXO.mjs       499.6kb
  chunk-HLM42XYM.mjs        19.7kb
...
main.js             | main          | 204.02 kB |                56.55 kB
polyfills.js        | polyfills     |  32.69 kB |                10.59 kB
styles.css          | styles        |   0 bytes |                 0 bytes

                    | Initial Total | 236.71 kB |                67.14 kB

Application bundle generation complete. [9.789 seconds]
Done in 10.54s.
```
Wed Nov 29 06:26:55 PM EST 2023
